    ...
    <Layout currentView={view} setView={setView}>
      {view === 'vehiculos' ? (
        <div>
              ...
              {vehiculos.map((coche) => (
                <div key={coche.id} className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-all">
                  ...
                  <div className="mt-6 flex gap-2">
                    <button className="flex-1 bg-slate-50 hover:bg-slate-100 text-slate-700 text-sm font-medium py-2 rounded border border-slate-200 transition-colors">
                      Ver Historial
                    </button>
          ...
          {/* El componente del Modal que contiene el formulario */}
          <Modal
            isOpen={isModalOpen}
